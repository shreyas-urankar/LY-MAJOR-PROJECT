...
function Transport() {
    ...
    const handleExportReport = async () => {
        try {
            const url = `http://localhost:5000/api/reports/dashboard/transport?city=Pune`;
            ...
            link.href = urlBlob;
            link.download = `urban_transport_report_Pune_${new Date().toISOString().split('T')[0]}.pdf`;
        ...
        <div className="min-h-screen bg-white text-gray-800">
            ...
            <div className="p-6 bg-gray-50">
                ...
                <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <button onClick={handleExportReport} className="px-3 py-1 bg-green-100 text-green-700 rounded-lg text-sm hover:bg-green-200 transition-colors">
                                Export Report
                            </button>
                        </div>
                    </div>
                ...
                <div className="mb-6">
                    <PredictionHeatmap 
                        percentage={82} 
                        title="AI Traffic Optimization Potential" 
                        description="Potential congestion reduction based on AI traffic signal optimization models"
                    />
                </div>
                            ...
                            <div className="flex space-x-2">
                                {['Day', 'Week', 'Month', 'Year'].map((range) => (
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-lg text-sm transition-colors ${timeRange === range.toLowerCase()
